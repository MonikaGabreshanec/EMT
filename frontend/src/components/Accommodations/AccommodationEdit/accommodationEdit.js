...
const AccommodationEdit = (props) => {
    ...
    const onFormSubmit = (e) => {
        ...
        const numRooms = formData.numRooms !== -1 ? formData.numRooms : (props.accommodation ? props.accommodation.numRooms : 0);
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <form onSubmit={onFormSubmit}>
                                ...
                                <div className="mb-3">
                                    <label htmlFor="numRooms" className="form-label">num of Rooms</label>
                                    <input
                                        type="number"
                                        className="form-control"
                                        id="numRooms"
                                        name="numRooms"
                                        placeholder={props.accommodation ? props.accommodation.numRooms : ''}
                                        onChange={handleChange}
                                    />
                                </div>
